...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Douglas')
    ...
    def add_btn(self, btn, row, col, rowpan, colspan, funcao=None, style=None):
        self.grid.addWidget(btn, row, col, rowpan, colspan)
        if not funcao:
            btn.clicked.connect(
                lambda: self.display.setText(
